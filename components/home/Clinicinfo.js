...
const Clinicinfo = () => {
    return (<Box id="feature" sx={{ py: { xs: 10, md: 14 }, backgroundColor: 'background.paper' }}>
        <Container>
            <Grid container spacing={3}>
                <Grid item xs={12} md={5}>
                    <Box sx={{ position: 'relative', border: "3px solid black" }}>
                        <Image src="/images/clinicphoto2.png" height={100}
                            width={100}
                            layout='responsive' alt="Feature img" />
                        <Box sx={{
                            position: 'absolute',
                            top: -39,
                            right: { xs: 0, md: -35 },
                ...
                <Grid item xs={12} md={7}>
                    ...
                    <Typography sx={{ color: 'text.secondary', mb: 2, ml: { xs: 0, md: 4 } }}>
                        Dazzle Dental Clinic is your ideal destination for everything Dentistry in Mumbai. We offer world-class dental care and cutting-edge technology to give you the treatment you deserve. And we are  home to award-winning dentists that are dedicated to providing you with exceptional, anxiety free dental care.
                    </Typography>
